...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cta-section h2 { color: #000000; margin-bottom: 1rem; font-size: 2.5rem; font-family: 'Poppins', sans-serif; }
        ...
        @media (max-width: 968px) {
            ...
            .what-you-get-card-top { padding: 2.5rem 1.5rem; height: 160px; }
        ...
        @media (max-width: 768px) {
            ...
            .what-you-get-card-top { padding: 2rem 1.5rem; height: 140px; }
            .what-you-get-card-bottom { padding: 2rem 1.5rem; }
        ...
        @media (max-width: 480px) {
            ...
            .what-you-get-card-top { padding: 1.5rem 1rem; height: 120px; }
                ...
                <div class="portrait-text">
                    ...
                    <div class="pricing-section">
                        <div class="pricing-item">
                            <div class="pricing-title">Headshot Photography</div>
